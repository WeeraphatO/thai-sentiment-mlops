...
def compute_metrics(eval_pred) -> dict[str, float]:
    """Compute accuracy and weighted/macro F1 for a Trainer eval batch."""
...
def evaluate_on_test(
    ...
    """Run inference on the test set and return metrics + predictions."""
...
def plot_confusion_matrix(
    ...
    """Build a seaborn heatmap of the confusion matrix and return the figure."""
...
def log_artifacts_to_mlflow(
    ...
    """Log the confusion matrix, classification report, and model pipeline to MLflow."""
